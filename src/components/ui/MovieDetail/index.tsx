                    ...
                    <div className="mt-10 md:mt-20">
                        <div className="flex flex-col md:flex-row gap-5">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <button className="px-3 py-2 border border-zinc-400 dark:border-emerald-400 dark:text-emerald-400 flex items-center gap-1 rounded-md">
                                        <Heart size={24} />
                                        Add to watchlist
                                    </button>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="max-w-[300px] w-full flex flex-wrap">
                                        {
